...
AIBoardprint = createBoard(int(n), AIBoardprint)
print("My board is this: \n")
printBoard(myBoard)
print("\n")
print("AI board is this: \n")
printBoard(AIBoardprint)
...
while (not isWin(myBoard)) and (not isWin(AIBoard)):
    ...
    while(gameCol):
        ...
        if userTargetCol.isdigit() and (int(userTargetCol) >= 1) and (int(userTargetCol) <= n):
            ...
            print "Invalid input. Please only enter an integer row where 1 <= row <= "+str(n)+":  \n"
            gameCol = True
    ...
    if (square == "2" or square == "3" or square == "4" or square == "5"):
        ...
        AIBoardprint = updateBoard(AIBoardprint, (userTargetRow, userTargetCol), "H")
        print("You Hit ("+str(userTargetRow)+", "+str(userTargetCol)+")\n")
    else:
        AIBoard = updateBoard(AIBoard, (userTargetRow, userTargetCol), "M")
        AIBoardprint = updateBoard(AIBoardprint, (userTargetRow, userTargetCol), "M")
